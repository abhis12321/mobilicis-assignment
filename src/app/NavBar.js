...
export default function NavBar() {
    ...
    return (
        <div className='leading-[3rem] flex items-center justify-between px-7 py-1 bg-gradient-to-b from-gray-950 to-gray-800'>
            ...
            <div className="right-navbar hidden md:flex flex-col md:flex-row lg:gap-4 bg-gradient-to-r from-gray-800 to-slate-950 md:[background:none] min-w-[200px] min-h-[100vh] md:min-h-fit fixed md:static top-0 right-0">
                ...
                <div className="w-full md:w-fit flex items-center justify-center">
                    <Link href={''} className='hover:bg-gray-950/50 md:hover:bg-red-950/20 md:hover:shadow-[0_0_3px_white] text-center w-full md:min-w-28 md:px-4 md:rounded-xl'>Home</Link>
                </div>
                <div className="w-full md:w-fit flex items-center justify-center">
